    ...
    <div className="faq-content">
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <ul>
            <li>
              <strong>Unsheltered:</strong> People who live in places not meant
              for human habitation – on the streets, in cars, wooded areas, or
              abandoned buildings.
            </li>
            <li>
              <strong>Sheltered:</strong> People who are staying in homeless
              shelters or transitional housing until they find stable permanent
              housing of their own.
            </li>
            <li>
              <strong>Doubled Up:</strong> People that experience an eviction or
              similar crisis may have natural support networks and can avoid a
              homeless shelter by staying with family or friends, even though
              they cannot afford to find their own housing.
            </li>
            <li>
              <strong>Couch Surfing:</strong> People moving from one place to
              another in quick succession.{' '}
            </li>
          </ul>
          <p>
            Generally, “homeless” means lacking a fixed, regular, and adequate
            nighttime residence and living in temporary accommodations (e.g.
            shelter) or in places not meant for human habitation. Households
            fleeing domestic violence and similar threatening conditions are
            also considered homeless. For purposes of certain programs and
            funding, families with minor children who are doubled-up with family
            or friends for economic reasons may also be considered homeless, as
            are households at imminent risk of homelessness.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <p className="faq-section-text">
            ...
            difficulty maintaining stable rental housing. Multiple studies
          ...
          <p className="faq-section-text">
            ...
            weekly to afford a two-bedroom rental unit in the average Florida
            community. Even for those who are working multiple jobs, being able
            to afford a rental unit in Florida is challenging. For the average
            two-bedroom rental unit to be affordable working 40 hours per week,
            the household would need to earn almost $20 per hour. However, many
          ...
          <p className="faq-section-text">
            ...
            extremely low-income households pay at least half of their income
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <p>
            ...
            a disability, or are not able to quickly earn the money they need
            for rent turn to programs like:
          </p>
          <ul>
            <li>
      ...
      <div>
        ...
        <div className="faq-section">
          <p className="faq-section-text">
            ...
            . Health problems can cause a person’s homelessness as well as be
          ...
          <ul>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                Strategies of State Mental Health Agencies to Prevent and End
                Homelessness
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                Addressing stigma, disparities in minority mental health: Access
                to care among barriers
              </a>
            </li>
            <li>
              <a
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <p className="faq-section-text">
            ...
            homelessness makes it more challenging for the head of household
            wage-earner to become or stay employed, precipitating a downward
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <p className="faq-section-text">
            ...
            country and Florida’s top priorities. Despite the fact this group
            makes up less than 16 percent of those who are homeless in Florida,
            it is likely that when a typical taxpayer, business owner, or
            tourist thinks about the word “homeless,” chronically homeless
            individuals are most likely to come to mind.
          </p>
          <p>
      ...
      <div>
        ...
        <div className="faq-section">
          <p className="faq-section-text">
            ...
            guardian, and go to sleep without the safety, stability and support
          ...
          <ul>
            ...
            <li>
              ...
              unaccompanied youth and young adults up to age 24 experience a
              homelessness episode of longer than one week. More than half are
              under the age of 18.
            </li>
          </ul>
          <p className="faq-section-text">
      ...
      <div>
        <span
          id="creating-systems-that-work"
          className="resource-scroll-anchor"
        />
        ...
        <div className="faq-section">
          ...
          <ul>
            <li>
              ...
              designed to quickly identify, assess, refer and connect people in
              crisis to housing and assistance, no matter where they show up to
              ask for help.
            </li>
            <li>
              <strong>Planning:</strong> Establishing a plan helps communities
              set goals and conceptualize what they should prioritize.
            </li>
            <li>
              <strong>Collecting &amp; Analyzing Local Data:</strong> Collecting{' '}
              <a
            ...
            <li>
              ...
              client, program, and system-level data on the provision of housing
              and services to homeless individuals and families and persons at
              risk of homelessness. Each Continuum of Care is responsible for
              operating an HMIS system according to the U.S. Department of
              Housing and Urban Development’s (HUD) Data Standards.
            </li>
            <li>
              <strong>Performance Measurement &amp; Evaluation:</strong>{' '}
              Performance measures can be used by communities to examine
              progress and to assess what steps they should be taking to further
              reduce homelessness. HUD has developed{' '}
              <a
              ...
              to help communities gauge their progress in preventing and ending
              homelessness.
            </li>
          </ul>
          <h5>Related Resources:</h5>
      ...
      {/* Rapid Re-Housing */}
      <div>
        <span id="rapid-rehousing" className="resource-scroll-anchor" />
        <h3>Rapid Re-Housing</h3>
        <div className="faq-section">
          <p>
            A housing intervention designed to move a household into permanent
            housing (e.g. a rental unit) as quickly as possible, ideally within
            30 days. This is the best way to help households with moderate to
      ...
      <div>
        <span
          id="permanent-supportive-housing"
          className="resource-scroll-anchor"
        />
        ...
        <div className="faq-section">
          ...
          <p className="faq-section-text">
            ...
            the best way to help households with the greatest barriers to
        ...
        <div className="faq-section">
          ...
          <ul>
            <li>
              ...
              they naturally stay (e.g. in campsites, on the streets), building
              trust through assertive engagement, and offering access to
              appropriate housing interventions.{' '}
            </li>
            <li>
              <strong>Coordinated Entry: </strong>This is a standardized
              community-wide process to outreach, identify, and triage homeless
              households. This process consists of utilizing a common tool to
              assess the level and type of needs, enter the household
              information into the local Homeless Management Information System
              (HMIS), provide appropriate referrals, and prioritize access to
              housing interventions and services to end their homelessness.
            </li>
            <li>
              <strong>Diversion &amp; Prevention: </strong>
              <em>Prevention</em> provides services and financial assistance to
              prevent someone from becoming homeless. <em>Diversion</em> is a
              strategy that prevents homelessness for people at the point when
              they are seeking shelter.
            </li>
            <li>
              <strong>Emergency Shelters/Interim Housing: </strong>A facility
              operated to provide temporary shelter for homeless people.
              Effective emergency shelters do not have barriers to entry (such
              as a sobriety requirement) and should be focused on connecting
              people with housing options to help them return to affordable
              rental units.
            </li>
            <li>
              <strong>Permanent Housing: </strong>Safe and affordable housing
              for people with disabling conditions, with legal tenancy housing
              rights and access to flexible support services.{' '}
              <em>Rapid Re-Housing</em> is designed to move a household into
      ...
      <div>
        ...
        <div className="faq-section">
          ...
          <p className="faq-section-text">
            ...
            one. With incomes typically much lower than is needed to comfortably
            pay average rental costs, millions of people are financially
            vulnerable to homelessness and housing instability. A reduction in
            work hours, a lost job, an illness or an unexpected expense can
            spiral into an inability to pay the rent, an eviction, reliance on
